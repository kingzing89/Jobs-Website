    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <x-nav-link type="a" href="/index" :active="request()->is('/')">Home</x-nav-link>
                                <x-nav-link type="a" href="/about" :active="request()->is('about')">About</x-nav-link>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between sm:items-center">
                ...
                <div>
                <a href='/jobs/create' class="inline-flex items-center rounded-md bg-red-50 px-2 py-4 mt-3  text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 box-shadow cursor-pointer">Create a New Job</a>
                </div>
                @endif
            </div>
        </header>
